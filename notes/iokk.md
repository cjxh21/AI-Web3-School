...
今天查看了一下黑客松相关的话题和团队项目，但是自己目前没有找到团队，所以黑客松项目可能参加不了，希望自己后面有空的时候去补足一下基础知识，因为目前在做。其他项目的事情，希望自己后面能够有机会正式参加。

![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/AI-Web3-School/main/assets/iokk/images/2026-06-07-1780846325980-image.png)
<!-- DAILY_CHECKIN_2026-06-07_END -->

# 2026-06-06
<!-- DAILY_CHECKIN_2026-06-06_START -->

今天有学习相关的黑客松相关的具体设置以及规则，通过查看昨天的直播回放。并且在考虑选择赛道，目前比较关注向AI发展的赛道，可以去做一个笔记，并且有详细的赛事规划和积分机制，但是目前具体的项目的落地形式没想好。
...
> 今天有看了大佬的直播。
> 
> ![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/AI-Web3-School/main/assets/iokk/images/2026-06-05-1780675072939-image.png)
> 
>   
>   
> AI Agent 让“自动决策、自动交易、自动协作”变得现实，而区块链的价值不是重新包装金融叙事，而是给 Agent 提供身份、资产、权限、结算和可验证协作层。区块链在 Agent 时代的角色不是“万能数据库”，而更像：

-   Agent 的身份层：这个 Agent 是谁，谁授权的？
    
-   Agent 的资产层：它能不能持有、支付、收款？
    
-   Agent 的权限层：它能操作什么，额度多少？
    
-   Agent 的协作层：多个 Agent 怎么可信协作？
    
-   Agent 的审计层：它做过什么，是否可追责？
    

印象让我比较深的还是。AI的出现让开发成本显著降低，那么我们应该更多地去思考资产之间的关系，做好数据从收集、整理，再到上线，再到运营的完整闭环。
...
![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/AI-Web3-School/main/assets/iokk/images/2026-06-03-1780501805007-image.png)

-   Solidity 基础：状态变量、mapping、event、modifier、ERC20/ERC721、合约调用
    
-   Foundry：forge build、forge test、部署脚本
...
计划学习一下黑客松，没有参加过，第一次可以。练实操：用 `ethers` 或 `viem` 完成查余额、转账、调用合约，读懂一个开源钱包项目。做小项目：先做最小版 `Agent 钱包`，实现地址管理、交易发起、简单自动化。
...
**经过之前的学习，计划开始做一个实验。实验题目：AI 帮我解释一笔测试网交易，并辅助我完成一次人工确认后的链上执行**

流程是：

-   先让 AI 解释一笔测试网交易或一个 `ABI`
...
![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/AI-Web3-School/main/assets/iokk/images/2026-05-31-1780243110394-image.png)
...
![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/AI-Web3-School/main/assets/iokk/images/2026-05-29-1780070392576-image.png)

主要包含三部分：

1.  **Learning Paths｜学习路径**  
    介绍如何从零开始学习 AI、区块链、智能合约、去中心化应用等技能。
    
2.  **Collaboration Networks｜协作网络**  
    连接全球女性开发者、项目方、导师、投资人和社区，一起做项目、交流资源。
    
3.  **Global Opportunities｜全球机会**  
    分享远程工作、黑客松、创业融资、开源项目、国际会议和职业发展的机会。
