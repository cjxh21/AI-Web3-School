...
1.基础知识方面：依旧以handbook为主，拓展学习为辅，每日看一下专有名词等基础知识进行巩固。

2.链上实操方面：今日用测试网成功实现了一次交易，在区块浏览器里面查询了详细的交易信息。

3.AIxWeb3课程学习方面：也参加了晚上的co-learning，听助教和其他同学的分享，在这里立一个小小的flag，我要参加下次的co-learning和助教交流。

4.今日反思总结：基础知识真的要多理解记忆，线上实操多进行，有问题多和同学交流，自己死磕效率不太行，ai能做的只是基础，想要深度学习实操还是要回归现实。
