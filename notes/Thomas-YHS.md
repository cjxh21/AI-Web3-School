...
-   写清楚 3 条边界判断：模型能力边界、工具调用边界、钱包签名边界
    
-   更新今天的 check-in draft
...
-   把前几天的主线压成一个可复用框架：
    ...
    -   model -> prompt/context -> tool use -> wallet/signature -> transaction -> verification
        
-   继续推进一个独立产物：`tasks/hermes-first-workflow.md` 或 permission boundary 对比笔记
    
-   在例会后补 3 条：我学到的、我还没做完的、我下周要推进的
