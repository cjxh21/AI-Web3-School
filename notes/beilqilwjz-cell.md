...
![](https://datawhalechina.github.io/easy-vibe/assets/image1.QsoN6GVT.png)

在能力层面，它和你可能听说过的其他模型（如 GPT-4o、Claude、Qwen、Midjourney 等）并没有本质区别：**输入描述，模型负责生成结果。**

![](https://datawhalechina.github.io/easy-vibe/assets/image2.B8eaKxeK.png)![](https://datawhalechina.github.io/easy-vibe/assets/image3.BqrS4l0o.png)![](https://datawhalechina.github.io/easy-vibe/assets/image4.BLR0mPCO.png)

你可以把它理解为一支“画笔”。我们在这一章只关心一件事： 👉 **这支画笔能不能在你手里画出第一笔。**
...
![](https://datawhalechina.github.io/easy-vibe/assets/image5.D6MGJEr8.png)

2.  新建一个 Python 文件
    

![](https://datawhalechina.github.io/easy-vibe/assets/image6.7sHpamMW.png)

![](https://datawhalechina.github.io/easy-vibe/assets/image7.BrSOA55d.png)

![](https://datawhalechina.github.io/easy-vibe/assets/image8.BsQ_y3Xh.png)
...
当 Trae 提示运行成功后，点击它提供的本地链接（通常是 [**http://127.0.0.1:7860**）。](http://127.0.0.1:7860）。)

![](https://datawhalechina.github.io/easy-vibe/assets/image9.DSwQMuMO.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image10.CBXdXk7H.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image11.FtcraBjI.png)![](https://datawhalechina.github.io/easy-vibe/assets/image12.BWbry3ZB.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image13.C-Rvc3CU.png)

在Output Image区域点击下载图片即可保存到本地。

![](https://datawhalechina.github.io/easy-vibe/assets/image14.DVKFX2ha.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image15.BFKki1wG.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image16.Cri0xBt6.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image17.BRLUnG61.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image18.DUzM92Xr.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image19.f0L8DTcz.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image20.B5a_bx6X.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image21.OmSn2znn.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image22.BUIqy2bF.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image23.KGkXs_rc.png)

![](https://datawhalechina.github.io/easy-vibe/assets/image24.D1CoYQjq.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image25.DD_Yhof1.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image26.inDX9_yw.png)

![](https://datawhalechina.github.io/easy-vibe/assets/image27.CjJ-u9zm.png)
...
**原生 API 的问题：** 你需要自己思考角色设定、情绪状态，并为每一张图单独编写 prompt。
...
![](https://datawhalechina.github.io/easy-vibe/assets/image28.lxwYGJsi.png)![](https://datawhalechina.github.io/easy-vibe/assets/image29.M71cZn72.png)

这一步，AI 从“执行者”转变为“策划者”。在AI帮你分析完需求后，可以在Lovart的画布区看到多种风格和内容的程序员鸭子图片。可以开始筛选你喜欢的风格。

![](https://datawhalechina.github.io/easy-vibe/assets/image30.Dpipo5Ph.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image31.Cj99Bcm0.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image32.C3baM6AX.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image33.1t5Hk1bO.png)

![](https://datawhalechina.github.io/easy-vibe/assets/image34.DHNL1YMf.png)

![](https://datawhalechina.github.io/easy-vibe/assets/image35.D5vi0Xp3.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image36.DtEqamGX.png)

![](https://datawhalechina.github.io/easy-vibe/assets/image37.CVOig8l5.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image38.Dy7IY7e5.png)

![](https://datawhalechina.github.io/easy-vibe/assets/image39.D2PEfLDD.png)

这些并不是简单滤镜，而是 Agent 自动调度不同工具完成的结果。

而在确定完基调风格后，可以很快速的生成一系列的表情包图像。

![](https://datawhalechina.github.io/easy-vibe/assets/image40.BdN2gxDU.png)
...
本教程不对任何套餐做推荐或比较；如果在实际使用中有需求，可以根据个人情况选择付费升级。 目前支持通过**支付宝**等方式完成支付。

![](https://datawhalechina.github.io/easy-vibe/assets/image41.DS68PnTT.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image42.lq5Y2gPy.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image43.Dwi-WbPi.png)
...
1.  **语言模型作为决策核心** 它负责理解文章内容、判断用户输入的意图，并将任务分发到合适的生成路径中，决定接下来“该怎么做”以及如何生成生图提示词。
    
2.  **图像模型作为执行者** 图像模型不参与理解与判断，只接收已经整理好的视觉指令，专注完成图像渲染。
    
3.  **用户作为可介入的引导者** 除了直接输入文本，用户还可以在过程中手动调整生成的提示词，或加入参考图来辅助生成，从而对最终结果进行引导和微调。
    
4.  **Gradio 与后端 API 作为整体承载层** 它们负责将界面、模型调用和结果展示串联起来，保证整个 Agent 能够以一个完整 Web 应用的形式稳定运行。
    

![](https://datawhalechina.github.io/easy-vibe/assets/image44.lzQyi4EX.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image26.DhW1YV_k.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image27.C1P5flvG.png)

![](https://datawhalechina.github.io/easy-vibe/assets/image28.B5984QOJ.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image48.Df2rELL3.png)

**环节1️⃣：Gradio Blocks 基础框架与界面布局**

在这个环节，我们的主要目标是先给整个Agent搭建出一个“外观”，实现前端的页面设计。复制以下Prompt在Trae对话框中实现后，你将会得到一个本地的URL（通常是 [**http://127.0.0.1:7860**](http://127.0.0.1:7860) ）即可查看界面，并且检验实现效果。
...
在浏览器打开[http://127.0.0.1:7860后可看到Trae已经按照我们的要求生成了以下的网页，跟我们的要求大致相当，可以进行到下一步的生成中了。](http://127.0.0.1:7860后可看到Trae已经按照我们的要求生成了以下的网页，跟我们的要求大致相当，可以进行到下一步的生成中了。)

![](https://datawhalechina.github.io/easy-vibe/assets/image49.D9cMMMtS.png)
...
刷新之前的[http://127.0.0.1:7860网址，开始测试是否能正确检测三种情况。](http://127.0.0.1:7860网址，开始测试是否能正确检测三种情况。)

1.  无意义内容，可以尝试输入“你好”、“谢谢”等，发现能够正常识别。
    

![](https://datawhalechina.github.io/easy-vibe/assets/image50.DSIYnWup.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image51.CwioI8Gf.png)

3.  直接绘图指令，这里输入的是“我要画一只猫”，同样检测准确。
    

![](https://datawhalechina.github.io/easy-vibe/assets/image52.VkSw3VLL.png)
...
> 你现在是一个创建NanoBanana画图提示词的助手。 需要根据我的内容处理，我这个图片的作用是能说明这一段在说什么，并且让大家知道这段话的上下结构就是整体说的是什么意思。 里面可能会类似PPT有一些讲解（如：左上角展示核心观点，右下角展示数据）。 设计风格要求：简约，Apple设计思维（Apple Design Philosophy）。 约束：请直接返回NanoBanana可用的英文提示词，不要返回任何解释、前缀或多余的废话。

如果你想换成其他的预设模版，可以在前面的prompt里修改，或者直接在Trae里通过对话修改。

![](https://datawhalechina.github.io/easy-vibe/assets/image53.BLhq_tXr.png)

除了修改底层代码，我们在网页上也可以快速编辑。举个例子，我在这里加了一句，“在前面加一句Pic Prompt”，可以看到生成的新的提示词前面也包含了～这样设计是为了方便快速修改生成提示词的System Prompt，帮助我们快速切换风格。

![](https://datawhalechina.github.io/easy-vibe/assets/image54.DYWuXPls.png)
...
![](https://datawhalechina.github.io/easy-vibe/assets/image55.DX8mj5qF.png)

太令人激动啦！我们终于顺利地生成出了这个Agent的第一张图，仔细看看生成的图片，跟我们的文本和提示词是匹配的。到这里你已经基本上实现你自己的Agent啦！

![](https://datawhalechina.github.io/easy-vibe/assets/image56.2DZq-328.png)

我们还添加了图生图功能，上传你喜欢的图片，AI会自动借鉴风格。

![](https://datawhalechina.github.io/easy-vibe/assets/image57.CAGYNcn9.png)
...
[https://www.notion.so/Web3-8708b3b678b7834ca00e01acf8f4a980?source=copy\_link](https://www.notion.so/Web3-8708b3b678b7834ca00e01acf8f4a980?source=copy_link)
...
接入claude code 部署在终端 ，配置相关skill，mcp服务
...
[https://www.notion.so/LLM-Transformer-3648b3b678b781b28546de54f0779cd5?source=copy\_link](https://www.notion.so/LLM-Transformer-3648b3b678b781b28546de54f0779cd5?source=copy_link)
